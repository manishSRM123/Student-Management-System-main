...
class StudentManagementSystem:
    def __init__(self, root):
        ...
        Label(self.login_frame, text="Username", font=("times new roman", 20, "bold"), bg="yellow").place(x=450, y=200)
        self.username_entry = Entry(self.login_frame, font=("times new roman", 15), bg="lightgray")
        self.username_entry.place(x=600, y=205)

        Label(self.login_frame, text="Password", font=("times new roman", 20, "bold"), bg="yellow").place(x=450, y=300)
        self.password_entry = Entry(self.login_frame, show="*", font=("times new roman", 15), bg="lightgray")
        self.password_entry.place(x=600, y=305)

        login_button = Button(self.login_frame, text="Login", command=self.login, font=("times new roman", 15, "bold"),
                              bg="green", fg="white")
        login_button.place(x=600, y=400)

    def login(self):
        if self.username_entry.get() == "admin" and self.password_entry.get() == "124578":
    ...
    def manage_frame(self):
        ...
        # Your existing code for the management frame here
        # ==============Manageframe============================================
        Manage_Frame = Frame(self.root, bd=4, relief=RIDGE, bg="Green")
        Manage_Frame.place(x=20, y=100, width=450, height=585)

        m_title = Label(Manage_Frame, text="Student Details", bg="yellow", fg="black",
        ...
        # =========Button Frame==================
        btn_Frame = Frame(Manage_Frame, bd=3, relief=RIDGE, bg="orange")
    ...
    def add_students(self):
        # Your existing code for adding students here
    ...
    def clear(self):
        # Your existing code for clearing data here
    ...
    def get_cursor(self, ev):
        # Your existing code for getting cursor data here
...
root = Tk()
ob = StudentManagementSystem(root)
root.mainloop()
